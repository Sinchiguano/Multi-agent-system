...
if __name__=="__main__":
    ...
    #robot1_tf
    pub1= rospy.Publisher('/robot1/mobile_base/commands/velocity', Twist, queue_size=5)
    ...
    #robot2_tf
    pub2 = rospy.Publisher('/robot2/mobile_base/commands/velocity', Twist, queue_size=5)
    ...
    #robot3_tf
    pub3 = rospy.Publisher('/robot3/mobile_base/commands/velocity', Twist, queue_size=5)
