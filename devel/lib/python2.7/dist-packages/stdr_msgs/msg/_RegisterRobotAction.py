...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_f().pack(self.action_result.result.description.footprint.radius))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_result.result.description.kinematicModel.type = str[start:end].decode('utf-8')
      else:
